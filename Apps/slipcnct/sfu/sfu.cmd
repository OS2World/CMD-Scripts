/* SFU Logon Script for OS/2 Warp Version 3 */
/* Created: October 15, 1994                            */
/* Tested: December 5,1994                           */

/* ****************************************** */
/* IMPORTANT: This script was tested using the dialer */
/* settings outlined in SFU.TXT. You should read that */
...
say 'SFU OS/2 Warp SLIP Login Script ',
    '(interface' interface')'
...
call waitfor 'Annex', 5; call flush_receive 'echo'
call send cr
