/* Uniserve Logon Script for OS/2 Warp Version 3 */
/* Created: October 28, 1994                            */
/* Tested: December 5, 1994                             */

/* ****************************************** */
/* IMPORTANT: This script was tested using the dialer */
/* settings outlined in UNISERVE.TXT. You should read that */
...
say ''
say 'Uniserve Information Services - OS/2 Warp SLIP Script ',
    '(interface' interface')'
...
call waitfor 'account details)'; call flush_receive 'echo'
call send 'y' || cr
...
/* to parse the stuff we get from the uniserve after waiting for an   */
