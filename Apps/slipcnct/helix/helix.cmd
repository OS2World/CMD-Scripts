...
helix_route = '142.231.37.2'
helix_local_ip = '192.0.2.1'

say 'Helix OS/2 Warp SLIP Login Script ',
    '(interface' interface')'
...
call waitfor 'CONNECT' ; call waitfor crlf, 5
...
call waitfor '(? for help) >'; call flush_receive 'echo'
call send 'TIA' || cr

os2_address = helix_local_ip
annex_address = helix_route
