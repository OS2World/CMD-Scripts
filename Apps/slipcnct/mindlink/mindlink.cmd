...
/* Created: October 27, 1994                            */
/* Tested: December 5, 1994                            */

/* ****************************************** */
/* IMPORTANT: This script was tested using the dialer */
/* settings outlined in MINDLINK.TXT. You should read that */
/* file (should be in this zip) before attempting to */
/* connect. */
/* ****************************************** */


parse arg interface , dialcmd username password modeminit
...
say ''
say 'Mindlink Information Services - OS/2 Warp SLIP Script ',
    '(interface' interface')'
...
call waitfor 'key:' ; call flush_receive 'echo'
call send cr
call send cr
...
/* to parse the stuff we get from the Mindlink after waiting for an   */
/* appropriate point in the data stream.                           */
call waitfor '(deep' 
parse var waitfor_buffer . 'You are connected to ' a '.' b '.' c '.' d .
