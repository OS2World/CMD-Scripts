/* Wimsey Logon Script for OS/2 Warp Version 3 */
/* Created: October 16, 1994                            */
/* Tested: December 5, 1994                             */

/* ****************************************** */
/* IMPORTANT: This script was tested using the dialer */
/* settings outlined in WIMSEY.TXT. You should read that */
...
say ''
say 'Wimsey Information Services - OS/2 Warp SLIP Script ',
    '(interface' interface')'
...
/* to parse the stuff we get from the wimsey after waiting for an   */
...
parse var waitfor_buffer  a '.' b '.' c '.' d ' beginning....'.
os2_address = a||'.'||b||'.'||c||'.'||d
