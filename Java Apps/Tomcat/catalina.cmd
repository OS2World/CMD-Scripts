...
if exist "%CATALINA_HOME%\bin\setenv.cmd" call "%CATALINA_HOME%\bin\setenv.cmd"

rem Get standard Java environment variables
if exist "%CATALINA_HOME%\bin\setclasspath.cmd" goto okSetclasspath
echo Cannot find %CATALINA_HOME%\bin\setclasspath.cmd
echo This file is needed to run this program
goto end
:okSetclasspath
set BASEDIR=%CATALINA_HOME%
call "%CATALINA_HOME%\bin\setclasspath.cmd"

rem Add on extra jar files to CLASSPATH
if "%JSSE_HOME%" == "" goto noJsse
set CLASSPATH=%CLASSPATH%;%JSSE_HOME%\lib\jcert.jar;%JSSE_HOME%\lib\jnet.jar;%JSSE_HOME%\lib\jsse.jar
:noJsse
set CLASSPATH=d:\sqllib\java\db2java.zip;%CLASSPATH%;%CATALINA_HOME%\bin\bootstrap.jar
