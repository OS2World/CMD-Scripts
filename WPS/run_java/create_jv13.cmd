/*Java13 object creator*/
/*------------------------------------------------------------------*/
/* Just copy the create_jv13.cmd, install.cmd, java_13.cmd, 
...
app_obj_id = 'jv13_'||app_name
app_name = app_name||"__jv13"
