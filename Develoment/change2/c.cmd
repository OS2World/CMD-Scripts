...
/*        in a vera easy manner.                           */
"@ echo off"

  Y="C"             /* Here type the drive letter on which  */
                    /* the buffer files  of  c.cmd          */
                    /* will be interim stored               */
                    /* while  c.cmd  is running.            */
  X=Y||":"||"\"
...
LWAnz:
  ...
  say
  Call Charout,"   A drive  "
                           Call Color "cyan"
  Call Charout,param
                           Call Color "yellow","black"
  Call Charout,"  does not exist on this computer"
  say
...
VzUVz:
  ...
  Call CsrAttrib "High";   Call Color "yellow","black"
  say
  Call Charout,"   A subdirectory  "
                           Call Color "cyan"
  Call Charout,param2
                           Call Color "yellow","black"
  say
  Call Charout,"   does not exist  "
  say
  Call Charout,"     in directory  "
                           Call Color "cyan"
  Call Charout,param1
  say
  Call CsrAttrib "Normal"; Call Color "white","black"
...
LWStamm:
  ...
  Call Charout,"          does not exist  "
  say
  Call Charout,"   in the root directory  "
  say
  Call Charout,"                of drive  "
                           Call Color "cyan"
  Call Charout,param1
  say
  Call CsrAttrib "Normal"; Call Color "white","black"
